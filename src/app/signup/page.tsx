...
export default function SignupPage() {
  return (
    <div style={{ maxWidth: 400, margin: "60px auto", background: "#fff", borderRadius: 12, boxShadow: "0 2px 8px #e0e0e0", padding: 40 }}>
      <h2 style={{ fontSize: 22, fontWeight: 700, color: "#4b5e2e", marginBottom: 24, textAlign: "center", letterSpacing: 1 }}>회원가입</h2>
      <form style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        <div>
          <label style={{ fontWeight: 500, color: "#333" }}>휴대폰 번호</label>
          <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
            <input type="tel" placeholder="010-1234-5678" style={{ flex: 1, padding: 10, borderRadius: 6, border: "1px solid #b2c7a7", fontSize: 16 }} />
        ...
        <div>
          <label style={{ fontWeight: 500, color: "#333" }}>실명</label>
          <input type="text" placeholder="이름 입력" style={{ width: "100%", padding: 10, borderRadius: 6, border: "1px solid #b2c7a7", fontSize: 16, marginTop: 4 }} />
        </div>
        <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <label htmlFor="terms" style={{ color: "#333", fontSize: 15 }}>
            이용약관 및 개인정보처리방침 동의
          </label>
        </div>
