...
export default function ProductsPage() {
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
      <h2 style={{ fontSize: 24, fontWeight: 700, color: "#4b5e2e", margin: "32px 0 24px 0" }}>투자 상품 목록</h2>
      {/* 필터 영역 */}
      <section style={{ display: "flex", gap: 16, marginBottom: 24 }}>
        <select style={{ padding: 8, borderRadius: 6, border: "1px solid #b2c7a7", fontSize: 15 }}>
          <option>전체</option>
          <option>과일</option>
          <option>수산물</option>
        </select>
        ...
        <input type="text" placeholder="상품명 검색" style={{ flex: 1, padding: 8, borderRadius: 6, border: "1px solid #b2c7a7", fontSize: 15 }} />
      </section>
      {/* 상품 카드 리스트 */}
      <section style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
        {/* 샘플 카드 */}
        <div style={{ background: "#fff", borderRadius: 12, boxShadow: "0 2px 8px #e0e0e0", padding: 24, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ fontWeight: 700, fontSize: 18, color: "#4b5e2e" }}>완주 딸기</div>
          <div style={{ color: "#666" }}>수익률: 7.2%</div>
          <div style={{ color: "#666" }}>모집금액: 1,000만원</div>
        ...
        <div style={{ background: "#fff", borderRadius: 12, boxShadow: "0 2px 8px #e0e0e0", padding: 24, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ fontWeight: 700, fontSize: 18, color: "#4b5e2e" }}>제주 감귤</div>
          <div style={{ color: "#666" }}>수익률: 5.8%</div>
          <div style={{ color: "#666" }}>모집금액: 2,000만원</div>
          <button style={{ background: "#6b8e23", color: "#fff", border: "none", borderRadius: 6, padding: "8px 0", fontWeight: 600, fontSize: 15, marginTop: 8 }}>투자하기</button>
        </div>
        <div style={{ background: "#fff", borderRadius: 12, boxShadow: "0 2px 8px #e0e0e0", padding: 24, display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ height: 120, background: "#e6f4d7", borderRadius: 8, marginBottom: 8, display: "flex", alignItems: "center", justifyContent: "center", color: "#bbb" }}>
          ...
          <div style={{ fontWeight: 700, fontSize: 18, color: "#4b5e2e" }}>영광 굴비</div>
          <div style={{ color: "#666" }}>수익률: 6.1%</div>
          <div style={{ color: "#666" }}>모집금액: 1,500만원</div>
